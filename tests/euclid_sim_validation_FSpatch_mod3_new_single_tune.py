...
slitless_file = simdata_path + "NISP_SLITLESS_FRAME1_FSpatch_mod3_16183_TAcalib_V1_R_newGRID_2024-05-17.fits"
#slitless_file = simdata_path + "NISP_SLITLESS_FRAME2_FSpatch_mod3_16183_TAcalib_V1_R_newGRID_2024-05-17.fits"
#slitless_file = simdata_path + "NISP_SLITLESS_FRAME3_FSpatch_mod3_16183_TAcalib_V1_R_newGRID_2024-05-17.fits"
#slitless_file = simdata_path + "NISP_SLITLESS_FRAME4_FSpatch_mod3_16183_TAcalib_V1_R_newGRID_2024-05-17.fits"
...
aXe.load_files(direct_file, slitless_file, pre_process_path=pre_process_path, offset=1024, fix_mosa=1, det='11',
remove_dc=0, correct_gain=1, diag=1, gain=2.0)
...
euc_dat = EuclidData(
    ...
    catalog2_path = "FSpatch_mod3_16183_TAcalib_V1_R_newGRID_2024-05-17/frame1/Catalogs/",
    model_spectra_path = "FSpatch_mod3_16183_TAcalib_V1_R_newGRID_2024-05-17/frame1/Input_Spectra/",
)
...
aXe.plot_cutout(vmin=-0.05, vmax=0.05, verb=1, flip_axes=1)
aXe.plot_trace(vmin=-0.05, vmax=0.05)
#aXe.plot_trace(x0=1350, x1=2350, y0=2800, y1=3800)
aXe.get_thumbnail(a0, d0)
#aXe.spectral_trace(disp_axis=0, nseg=56)
aXe.spectral_trace(disp_axis=0, nseg=56, vmin=-0.1, vmax=0.1, flip_axes=1)
#sys.exit()
