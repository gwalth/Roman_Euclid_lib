...
simdata_path = "/Users/gwalth/data/Roman/grizli/sims/Euclid/my_euclid_sim/Prep"
#raw_path = "/Users/gwalth/data/Roman/grizli/sims/Euclid/Raw/EuclidSIMS/Env9_V1_RN_2023-12-15/frame1/"
...
direct_file = simdata_path + "Euclid_4deg2_field_0013_v6_1000_direct.fits"
...
slitless_file = simdata_path + "Euclid_4deg2_field_0013_v6_1000_slitless.fits"
...
euc_dat = EuclidData(
        catalog1 = "Env9_mod3_15329_base_Felgt2em16_Visit1_TESTarray.fits",
        ...
        catalog1_path = "Env9_V1_RN_2023-12-15/frame1/Catalogs/",
        catalog2_path = "Env9_V1_RN_2023-12-15/frame1/Catalogs/",
        model_spectra_path = "Env9_V1_RN_2023-12-15/frame1/Input_Spectra/",
)
...
for i,(p0, c0) in enumerate(zip(points_culled[det11_idx][:Nfirst], pixcoords[det11_idx][:Nfirst])):
    ...
    ax2 = axes2.flat[i]
    ax2.imshow(cutout[0], origin="lower")
